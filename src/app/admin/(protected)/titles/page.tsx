  ...
  return (
    <div className="space-y-6">
      ...
      {titles && titles.length > 0 ? (
        <div className="bg-bg-surface border border-foreground/10 rounded-xl overflow-hidden">
        ...
        <div className="text-center py-12 bg-bg-surface border border-foreground/10 rounded-xl">
